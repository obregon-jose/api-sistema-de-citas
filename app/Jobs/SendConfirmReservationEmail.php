...
class SendConfirmReservationEmail implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        Mail::to($Client->email)->send(new ConfirmReservationMail(1, $this->client_name, $this->barber_name, $this->services_details, $this->total_paid, $this->date, $this->time, $this->status));
        $Barber = User::find($this->barber_id);
        Mail::to($Barber->email)->send(new ConfirmReservationMail(2, $this->client_name, $this->barber_name, $this->services_details, $this->total_paid, $this->date, $this->time, $this->status));
