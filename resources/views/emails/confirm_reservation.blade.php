...
<body>
  <div class="container">
    @if ($role === 1)
    <div class="header">
      Hola, <span>{{ $client_name }}</span>, tu reserva ha sido completada.<br>
    </div>
    @else
    <div class="header">
      Hola, <span>{{ $barber_name }}</span>, la reserva ha sido completada.<br>
    </div>
    @endif   
    
    <div class="section-title">
        DETALLES DE LA RESERVA COMPLETADA
    </div>
